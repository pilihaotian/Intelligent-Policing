...
**使用示例：**
```
点击右下方小图标，进入智能导航页面，输入关键词或自然语言，快速定位目标功能
```

> 📷 智能导航主页
![img.png](assets/img/smart-nav-main.png)
> 智能导航
缓存命中走本地，缓存未命中大模型分析意图
![img.png](assets/img/smart-nav-search.png)
> 快捷导航
![img.png](assets/img/smart-nav-quick.png)
> 为您推荐、热门导航、导航历史
![img.png](assets/img/smart-nav-history.png)
